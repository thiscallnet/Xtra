...
object C {
    ...
    const val TWITCH_GQL_DEVICE_ID = "twitch_gql_device_id"
    const val TWITCH_GQL_CLIENT_SESSION_ID = "twitch_gql_client_session_id"
    const val TWITCH_GQL_CONTEXT_ACCOUNT_ID = "twitch_gql_context_account_id"
