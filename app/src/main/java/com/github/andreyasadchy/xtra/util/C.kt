...
object C {
    ...
    const val DEFAULT_GQL_CLIENT_ID2 = "ue6666qo983tsx6so1t0vnawi233wa"
    const val DEFAULT_GQL_CLIENT_ID_WEB = "kimne78kx3ncx6brgo4mv6wki5h1ko"
    const val LEGACY_GQL_CLIENT_ID2 = "kd1unb4b3q4t58fwlpcbzcbnm76a8fp"
    const val DEFAULT_HELIX_CLIENT_ID = "ilfexgv3nnljz3isbm257gzwrzr7bi"
    const val DEFAULT_HELIX_REDIRECT = "https://localhost"
    ...
    const val GQL_TOKEN2_REFRESH = "gql_token2_refresh"
    const val GQL_TOKEN2_EXPIRES_AT = "gql_token2_expires_at"
    const val GQL_TOKEN2_CLIENT_ID = "gql_token2_client_id"
    const val GQL_TOKEN2_USER_ID = "gql_token2_user_id"
    const val GQL_TOKEN2_SCOPES = "gql_token2_scopes"
    const val GQL_TOKEN2_TYPE = "gql_token2_type"
    ...
    const val SETTINGS_SCHEMA_VERSION = 26
    ...
    const val LEGACY_LATEST_TAG_UPDATE_URL = "https://api.github.com/repos/thiscallnet/xtra/releases/tags/latest"
