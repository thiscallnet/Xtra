...
class HudLayoutEngineTest {
    ...
    fun `semantic pivots and fixed controls do not depend on content size`() {
        ...
        assertEquals(88f, compact.getValue(HudElementId.QUALITY).visualRect.width, .01f)
        assertEquals(88f, expanded.getValue(HudElementId.QUALITY).visualRect.width, .01f)
    }
